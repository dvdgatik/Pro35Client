...
function getSteps() {
  return ['Acontecimiento traumático severo', 'Recuerdos persistentes sobre el acontecimiento (durante el último mes)', 'Esfuerzo por evitar circunstancias parecidas o asociadas al acontecimiento (durante el último mes)','Afectación (durante el último mes)'];
}
